...
class CriptoListActivity : AppCompatActivity(), NodeListAdapter.onItemClickListener {
    ...
    override fun onItemClicked(note: Card) {
        Log.d("Titulo", "ok")
        val intent = Intent(this, CriptoDetailActivity::class.java)
        intent.putExtra("coin", note.coin)
